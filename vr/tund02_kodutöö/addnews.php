...
<body style="background-color:orange">
    ...
    <div class="container" style="max-width: 60%; margin-top:100px;">
        ...
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <br>
            <input type="text" class="form-control" name="newsTitle" placeholder="Sisesta uudise pealkiri" value="<?php echo $newsTitle; ?>"><br>
            <br>
            <label>Uudise sisu:</label><br>
            <textarea class="form-control" name="newsEditor" placeholder="Siia sisesta uudise sisu" rows="6" cols="40"><?php echo $newsContent; ?></textarea><br>
            <br>
            <input type="submit" class="btn btn-secondary" name="newsBtn" value="Salvesta uudis!">
            <span><?php echo $newsError; ?></span>
        </form>
        <br>
        <form action="news.php" ><input type="submit" value="Loe Uudiseid!" class="btn btn-secondary"/></form>
